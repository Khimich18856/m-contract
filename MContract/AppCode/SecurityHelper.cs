...
namespace MContract.AppCode
{
    ...
    {
        public static string Encryption(string ishText, string pass = "04463vjkjlt;yfz6@",
                   string sol = "3a8simp*", string cryptographicAlgorithm = "SHA1",
                   int passIter = 2, string initVec = "for5Blazor0in2u#",
                   int keySize = 256)
        {
        ...
        public static string Decryption(string ciphText, string pass = "04463vjkjlt;yfz6@",
               string sol = "3a8simp*", string cryptographicAlgorithm = "SHA1",
               int passIter = 2, string initVec = "for5Blazor0in2u#",
               int keySize = 256)
        {
